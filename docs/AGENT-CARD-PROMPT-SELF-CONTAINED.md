...
**body 核心要求**：
- 先忠实来源，再重编排。正文首先要把来源里已经有的真实信息整理清楚，而不是急着“提炼观点”。
- 原文里的具体差异、限定词、条件、步骤、优缺点、对比项要尽量保住，不能为了简洁写成空泛判断。
- 可以用短标题、短段落、列表、加粗等 Markdown 结构帮助阅读；不要写成满屏机械标签和命令口吻。
- 像学长聊天，不像辅导员发通知。一句话检验：读一遍，像学长私下跟我说的话 → 对；像辅导员发的通知 → 重写。
- **自包含原则**：读者是普通新生，不预设他们知道任何超出新生常识的东西。不要引用「来源」「指南」「该文档」——读者不知道你在说什么。不要用缩写/专有名词不解释。每张卡片必须独立成立，搜到就能用。来源信息不足 → 跳过，不凑数。

**body 补充判断规则**：可以有少量原文里没有的话，但只能做经验排序、踩坑提醒、时机建议或反直觉澄清，而且必须建立在来源已给出的信息上，不能盖过原文，更不能把原文里的具体信息写糊。
