...
3. **年份必标**：`body` 结尾加"（信息适用于X级方案，后续可能调整）"
...
这"一句话"可以是：
- **经验排序**：原文平铺三个模块，你点出"基础实践那 10-15 小时才是主力"
- **踩坑提醒**：原文写"志愿服务可计时长"，你补"必须是团委负责的项目，别的不认"
- **时机建议**：原文写"大一至大三均可"，你补"趁大一有空先占掉，拖到后面没空"
- **反直觉澄清**：原文写"自动置入课表"，你补"别因为不是自己选的就忘了它存在"

**检验法**：写完 body，问自己——"把这张卡删了，用户看原文会漏掉什么？"答得出来，这张卡才立得住。

### 语气规则（三条）

1. **不要套结构化标签**：别用「【一句话】【关键动作】【两个坑】【提醒】」这种格式
2. **少用祈使句**：把"务必把握""切记别拖""一定要加群"换成陈述加轻提醒
3. **高视角但平视**：正文要比原文多给东西，但姿态是平视的同伴，不是俯视的老师
