...
- body 先忠实来源，再重编排；不要把原文里的具体差异、条件、步骤、限定词写糊
- 可以有少量补充判断，但只能做经验排序/踩坑提醒/时机建议/反直觉澄清，且不能盖过原文
- 语气像学长聊天，不用"务必/切记"这类训话口吻；允许用短标题、列表、加粗帮助阅读
- sourceDescription 带年份/版本，body 结尾不加年份标注
